...
-   [**Controls**](control.qmd): deal with OTUs found in negative and positive controls

-   [**Global filtering**](filter.rare.qmd): filter out singletons and rare OTUs

-   [**Taxonomy filtering**](pages/taxonomy.qmd): filter OTUs based on taxonomy and BLAST quality thresholds
